...
class AppConstants {
  static const String appName = 'Bibo';
  static const String baseUrl = 'https://appbibo.com';
  ...
  static const String transferMoneyFromBiboToMart =
      '/api/customer/wallet/transfer-Bibo-to-mart';
