...
class _RefundRequestScreenState extends State<RefundRequestScreen> {
  final TextEditingController productApproximatePriceController =
      TextEditingController();
  final TextEditingController refundNoteTextController =
      TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BodyWidget(
        appBar: AppBarWidget(
            title: 'refund_request'.tr,
            showBackButton: true,
            centerTitle: true),
        body: Padding(
          padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
          child: GetBuilder<RefundRequestController>(
              builder: (refundRequestController) {
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: refundRequestController
                          .refundReasonModel?.data?.length,
                      itemBuilder: (context, index) {
                        return Column(children: [
                          InkWell(
                            onTap: () => refundRequestController
                                .setParcelRefundCurrentIndex(index),
                            child: Row(
                                ...
                                children: <Widget>[
                                  Expanded(
                                    ...
                                    refundRequestController
                                            .refundReasonModel?.data?[index] ??
                                        '',
                                    style: TextStyle(
                                      color: !(refundRequestController
                                                  .parcelRefundReasonCauseCurrentIndex ==
                                              index)
                    ...
                    GridView.builder(
                        shrinkWrap: true,
                        itemCount: math.min(
                            refundRequestController.proofImages.length + 1, 5),
                        padding: EdgeInsets.zero,
                        ...
                        itemBuilder: (context, index) {
                          if (index ==
                              refundRequestController.proofImages.length) {
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        Image.asset(Images.pickImageIcon,
                                            height: 24,
                                            width: 24,
                                            color: Theme.of(context)
                                                .textTheme
                            ...
                            return Stack(children: [
                              InkWell(
                                onTap: () => Get.to(() => ImageVideoViewer(
                                    proofImages:
                                        refundRequestController.proofImages,
                                    clickedIndex: index)),
                                child: Container(
                                  height: 100,
                                  width: 150,
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.file(
                                      refundRequestController
                                              .proofImages[index].path
                                              .contains('.mp4')
                                          ? File(refundRequestController
                              ...
                              if (refundRequestController
                                ...
                                InkWell(
                                  ...
                                  child: Center(
                                      child:
                                          Image.asset(Images.playButtonIcon)),
                                ),
                              Container(
                          ...
                          Expanded(
                            child: RichText(
                                text: TextSpan(
                                  ...
                                  TextSpan(
                                    text:
                                        ' ${'before_submit_refund_request'.tr}',
                                    style: textRegular.copyWith(
                                        fontSize: Dimensions.fontSizeSmall,
                                        color: Theme.of(context)
                                            .textTheme
                    ...
                    Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                                'upload_clear_view_of_image_or_video'.tr,
                                style: textRegular.copyWith(
                                    fontSize: Dimensions.fontSizeSmall,
                                    color: Theme.of(context)
                                        .textTheme
                          ...
                          Text('5. ',
                              style: textRegular.copyWith(
                                  ...
                                  color: Theme.of(context)
                                      ...
                                      .withValues(alpha: 0.8))),
                          Expanded(
                            child: Text('video_must_be_mp4'.tr,
                                style: textRegular.copyWith(
                                    fontSize: Dimensions.fontSizeSmall,
                                    color: Theme.of(context)
                                        .textTheme
  ...
  void _onSubmit() {
    ...
    String refundReason =
        refundRequestController.refundReasonModel?.data != null
            ? refundRequestController.refundReasonModel!.data!.isNotEmpty
                ? (refundRequestController.refundReasonModel?.data?[
                        refundRequestController
                            .parcelRefundReasonCauseCurrentIndex] ??
                    '')
                : ''
    ...
    if (productApproximatePriceController.text.trim().isEmpty) {
      ...
      refundRequestController.sendRefundRequest(
        ...
        productApproximatePrice:
            double.parse(productApproximatePriceController.text),
      );
    }
  }
}
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        const SizedBox(height: Dimensions.paddingSizeSmall),
        Text('give_refund_proof'.tr,
            style: textBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
        const SizedBox(height: Dimensions.paddingSizeSmall),
        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          PickButtonWidget(
            onTap: () => Get.find<RefundRequestController>()
                .pickProofImage(ImageSource.gallery, false),
            title: 'gallery_image'.tr,
            image: Images.galleryImageIcon,
          ),
          PickButtonWidget(
            onTap: () => Get.find<RefundRequestController>()
                .pickProofImage(ImageSource.camera, false),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          PickButtonWidget(
            onTap: () => Get.find<RefundRequestController>()
                .pickProofImage(ImageSource.gallery, true),
            title: 'gallery_video'.tr,
            image: Images.galleryVideoIcon,
          ),
          PickButtonWidget(
            onTap: () => Get.find<RefundRequestController>()
                .pickProofImage(ImageSource.camera, true),
