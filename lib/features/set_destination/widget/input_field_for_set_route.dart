...
class InputField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(height: 45,
      decoration: BoxDecoration(color: Theme.of(context).primaryColorDark.withValues(alpha:.25),
          borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall)),
      child: TextFormField(
        controller: controller,
        style: textRegular.copyWith(color: Colors.white.withValues(alpha:0.8)),
        focusNode: node,
        ...
        decoration: InputDecoration(
          ...
          hintStyle: textRegular.copyWith(color: Colors.white.withValues(alpha:0.5), fontSize : Dimensions.fontSizeSmall),
