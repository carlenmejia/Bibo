...
class TransferMoneyDialogWidget extends StatefulWidget {
  ...
  @override
  State<TransferMoneyDialogWidget> createState() =>
      _TransferMoneyDialogWidgetState();
}
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Image.asset(Images.transferMoneySymbolIcon,
                    height: 40, width: 40),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                Text('transfer_money_note1'.tr,
                    style: textBold, textAlign: TextAlign.center),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                Text('transfer_money_note2'.tr,
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText:
                        '${Get.find<ConfigController>().config?.currencySymbol ?? '\$'}300',
