          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
              child: Row(children: [
                ...
                Container(width: 1,height: 25,color: Theme.of(context).hintColor.withValues(alpha:0.25),margin: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraLarge)),
            ...
            Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
              child: rideController.tripDetails?.vehicle != null ? Row(children: [
                ...
                Container(decoration: BoxDecoration(
                  ...
                  color: Theme.of(context).hintColor.withValues(alpha:0.25)),padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeThree),
