          ...
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              SizedBox(height: 40 , child: Text(
                widget.fromAddress,
                style: textRegular.copyWith(color: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha:0.7) : null),
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: textRegular.copyWith(
                      color: Theme.of(Get.context!).primaryColor.withValues(alpha:.75),
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: textRegular.copyWith(color: Theme.of(Get.context!).primaryColor.withValues(alpha:.75),fontSize: Dimensions.fontSizeSmall),
                  overflow: TextOverflow.ellipsis,
                ),
              ) :
              const SizedBox(),
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                  ...
                  Container(
                    ...
                    child: Text(widget.entrance, style: textRegular.copyWith(
                        ...
                        color: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha:0.7) : null
                    )),
                  ),
                ]),
            ])),
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Row(children: [
                    ...
                    Text("total_distance".tr, style: textRegular.copyWith(
                        ...
                        Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha:0.7) : null,
                    )),
                  ]),
                  const SizedBox(width: Dimensions.paddingSizeSmall),
