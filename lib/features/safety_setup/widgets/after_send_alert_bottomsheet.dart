  ...
  void initState() {
    Get.find<SafetyAlertController>().getSafetyAlertDetails(
        Get.find<RideController>().currentTripDetails?.id ??
            Get.find<RideController>().rideDetails?.id ??
            '');
    super.initState();
  }
        ...
        child: Padding(
          ...
          child: Column(
              ...
              children: [
                ...
                if (safetyAlertController.customerAlertDetails?.data?.comment !=
                    null)
                  Container(
                    width: Get.width,
                ...
                Flexible(
                  child: ListView.separated(
                    itemCount: safetyAlertController
                            .customerAlertDetails?.data?.reason?.length ??
                        0,
                    shrinkWrap: true,
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        child: Text(
                            '${safetyAlertController.customerAlertDetails?.data?.reason?[index]}',
                            style: textSemiBold.copyWith(
                                fontSize: Dimensions.fontSizeLarge),
                            textAlign: TextAlign.center),
                      );
                ...
                Text(
                  safetyAlertController.customerAlertDetails?.data?.status !=
                          'solved'
                ...
                if (safetyAlertController.customerAlertDetails?.data?.status !=
                    'solved')
                ...
                if (Get.find<ConfigController>()
                  ...
                  InkWell(
                    onTap: () => launchUrl(Uri.parse(
                        "tel: ${Get.find<ConfigController>().config?.safetyFeatureEmergencyGovtNumber}")),
                    child: Row(
                        mainAxisSize: MainAxisSize.min,
