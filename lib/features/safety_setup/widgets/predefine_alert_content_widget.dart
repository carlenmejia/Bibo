...
class PredefineAlertContentWidget extends StatefulWidget {
  ...
  const PredefineAlertContentWidget(
      {super.key, this.fromTripDetailsScreen = false});

  @override
  State<PredefineAlertContentWidget> createState() =>
      _PredefineAlertContentWidgetState();
}

class _PredefineAlertContentWidgetState
    extends State<PredefineAlertContentWidget> {
      ...
      return Flexible(
        child: Padding(
          ...
          child: Column(
              ...
              children: [
                Text('select_safety_alert_reason'.tr,
                    style: textSemiBold.copyWith(
                        fontSize: Dimensions.fontSizeLarge)),
                Flexible(
                  child: ListView.separated(
                    itemCount: safetyAlertController
                            .safetyAlertReasonModel?.data?.length ??
                        0,
                    shrinkWrap: true,
                    itemBuilder: (context, index) {
                      return InkWell(
                        ...
                        child: SafetyRadioButton(
                          isSelected: safetyAlertController
                                  .safetyAlertReasonModel
                                  ?.data?[index]
                                  .isActive ??
                              false,
                          text: safetyAlertController.safetyAlertReasonModel
                                  ?.data?[index].reason ??
                              '',
                        ),
                      );
                    ...
                    : ButtonWidget(
                        ...
                        onPressed: () {
                          safetyAlertController
                              .storeSafetyAlert(controller.text)
                              .then((value) {
                            if (value) {
                              Get.back();
                              if (!widget.fromTripDetailsScreen) {
                                Get.find<RideController>()
                                    .showSafetyAlertTooltip();
                              }
